...
def model_transform():
    ...
    num_classes = 21
    model_coco = torch.load("./mmdetection/checkpoints/cascade_rcnn_r50_fpn_1x_20190501-3b6211ab.pth")
    # weight
    ...
    model_coco["state_dict"]["bbox_head.2.fc_cls.bias"] = model_coco["state_dict"]["bbox_head.2.fc_cls.bias"][
                                                          :num_classes]
    # save new model
    torch.save(model_coco, "./mmdetection/checkpoints/cascade_rcnn_r50_coco_pretrained_weights_classes_%d.pth" % num_classes)
